...
export class BICreatingTables1749005453920 implements MigrationInterface {
   name = 'BICreatingTables1749005453920';

   public async up(queryRunner: QueryRunner): Promise<void> {
      await queryRunner.query(
         `CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "role" character varying NOT NULL DEFAULT 'CUSTOMER', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`
      );
      await queryRunner.query(
         `CREATE TABLE "services" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" character varying NOT NULL DEFAULT 'SCHEDULED', "scheduled_date" character varying NOT NULL, "cost" character varying NOT NULL, "duration_in_min" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "deleted_at" TIMESTAMP, "vehicle_id" uuid, "customer_id" uuid, "mechanic_id" uuid, CONSTRAINT "PK_ba2d347a3168a296416c6c5ccb2" PRIMARY KEY ("id"))`
      );
      ...
      await queryRunner.query(
         `ALTER TABLE "services" ADD CONSTRAINT "FK_8195a399cc01bb0374aef4a88e9" FOREIGN KEY ("customer_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
      );
      await queryRunner.query(
